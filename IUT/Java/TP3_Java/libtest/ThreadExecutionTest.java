...
public class ThreadExecutionTest extends Thread {
	 ...
	 */
	public ThreadExecutionTest(Object classTest, Method methode,
			Logs logs) {
	...
	/**
	 * verifie si l'erreur est due à un echec
	 * 
	 * @param nomException l'exception recuperee
	...
	/**
	 * verifie si l'erreur est du à un timeout
	 * @param nomException exception recuperee 
